...
const NEED_ENCODE_PARAM_KEYS: string[] = [
  ...
  "CreateLogConf:userLogFormat",
  "CreateLogConf:regularExpression",
  "CreateLogConf:timeRegularExpression",
  "CreateLogConf:key",
  "CreateLogConf:type",
  "CreateLogConf:value",
  "UpdateLogConf:confName",
  "UpdateLogConf:userLogFormat",
  "UpdateLogConf:regularExpression",
  "UpdateLogConf:timeRegularExpression",
  "UpdateLogConf:key",
  "UpdateLogConf:type",
  "UpdateLogConf:value",
  "CreateLogSource:key",
...
const NEED_DECODE_PARAM_KEYS: string[] = [
  ...
  "GetLogConf:confName",
  "GetLogConf:logPath",
  "GetLogConf:userLogFormat",
  "GetLogConf:regularExpression",
  "GetLogConf:timeRegularExpression",
  "GetLogConf:key",
  "GetLogConf:value",
  "ListLogConfs:confName",
