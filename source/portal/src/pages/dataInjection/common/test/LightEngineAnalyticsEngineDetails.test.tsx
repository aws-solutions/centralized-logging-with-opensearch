...
import { LightEngineAnalyticsEngineDetails } from "../LightEngineAnalyticsEngineDetails";
...
describe("LightEngineAnalyticsEngineDetails", () => {
  it("renders without errors with metric", () => {
    renderWithProviders(
      <MemoryRouter>
        <LightEngineAnalyticsEngineDetails
          ...
          analyticsEngine={{
            ...
            metric: {
              ...mockS3ServicePipelineData.metric,
