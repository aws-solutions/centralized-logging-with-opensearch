...
class SchedulerClient:
    ...
    def get_schedule(self, name: str, group_name: str = "default") -> dict:
        ...
        try:
            response = self._scheduler_client.get_schedule(
                Name=name, GroupName=group_name
            )
            return response
        except Exception as e:
            logger.warning(e)
    ...
    def create_schedule(
        ...
        flexible_time_windows: dict = {"Mode": "OFF"},
    ) -> dict:
        ...
        if self.get_schedule(name=name, group_name=group_name):
            self._scheduler_client.update_schedule(
                FlexibleTimeWindow=flexible_time_windows,
            ...
            self._scheduler_client.create_schedule(
                FlexibleTimeWindow=flexible_time_windows,
                GroupName=group_name,
                Name=name,
                ScheduleExpression=schedule,
    ...
    def create_processor_schedule(
        self,
        pipeline_id: str,
        source_type: str,
        table_name: str,  # NOSONAR
        ...
        **kwargs,
        ...
        enrichment_plugins = (
            [] if "enrichment_plugins" not in kwargs else kwargs["enrichment_plugins"]
        )
        ...
        return self.create_schedule(
            ...
            schedule=schedule,
            flexible_time_windows={"Mode": "OFF"},
        )

    def create_merger_schedule(
        self,
        pipeline_id: str,
        source_type: str,
        table_name: str,
        ...
        **kwargs,
        ...
        return self.create_schedule(
            ...
            group_name=group_name,
            schedule=schedule,
            flexible_time_windows={"Mode": "FLEXIBLE", "MaximumWindowInMinutes": 30},
        )

    def create_archive_schedule(
        self,
        pipeline_id: str,
        source_type: str,
        table_name: str,
