    ...
    with mock_dynamodb():
        ...
        sub_account_link_table.put_item(
            Item={
                ...
                "createdDt": "2022-11-26T11:54:02Z",
                "region": "us-east-1",
                "status": "ACTIVE",
                "subAccountBucketName": "ca-test-loghubloggingbucket0fa53b76-1xwsd8z6oehh9",
        ...
        pipeline_table.put_item(
            Item={
                ...
                "createdDt": "2023-01-04T09:14:42Z",
                "parameters": [
                    {"parameterKey": "engineType", "parameterValue": "OpenSearch"},
                    {
                        "parameterKey": "logBucketName",
                        "parameterValue": "aws-waf-logs-loghub-123456789012-us-east-1",
                    },
                    {
                    ...
                    {"parameterKey": "replicaNumbers", "parameterValue": "1"},
                    {
                        ...
                        "parameterValue": "loghub1-2-1-loghubloggingbucket0fa53b76-61wb3dr92joe",
                    },
                    {
...
def test_lambda_function(s3_client, ddb_client, cloudfront_client, iam_client):
    ...
    assert item["createdDt"] == "2023-01-04T09:14:42Z"
    assert item["source"] == "test"
    assert item["stackName"] == "LogHub-Pipe-840af"
