...
def test_svc_manager(sts_client, ddb_client):
    ...
    document = svcManager.get_document_name("056627083435",
                                            DocumentType.AGENT_CONFIGURATION,
                                            "us-west-2")
    ...
    s3 = svcManager.get_client("056627083435", "dynamodb", Boto3API.CLIENT)
    s3 = svcManager.get_client("056627083435", "dynamodb", Boto3API.RESOURCE)
