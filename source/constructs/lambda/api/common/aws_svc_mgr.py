...
class SvcManager():
    ...
    def get_link_account(self, sub_account_id: str, region=default_region):
        ...
        if sub_account_id and sub_account_id != account_id:
            ...
            "agentConfDoc, subAccountBucketName, subAccountStackId, subAccountVpcId, subAccountPublicSubnetIds, subAccountKMSKeyArn, createdDt, #region ",
    ...
    def get_sub_account_links(self, page=1, count=1000):
        ...
        response = sub_account_link_table.scan(
            ...
            "agentConfDoc, subAccountBucketName, subAccountStackId, subAccountVpcId, subAccountPublicSubnetIds, subAccountKMSKeyArn, createdDt ",
            ExpressionAttributeNames={
                "#subAccountId": "subAccountId",
                "#subAccountName": "subAccountName",
                "#status": "status",
        ...
        for item in items:
            ...
            result["subAccountVpcId"] = item["subAccountVpcId"]
            result["subAccountPublicSubnetIds"] = item[
                "subAccountPublicSubnetIds"]
            result["subAccountKMSKeyArn"] = item["subAccountKMSKeyArn"]
