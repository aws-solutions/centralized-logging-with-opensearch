...
def ddb_client():
    with mock_dynamodb():
        ...
        log_agent_eks_deployment_kind_table_name = (
            "LogHub-LogAgentEKSDeploymentKindTable"
        )
...
class TestEksClusterManager:
    ...
    def test_lambda_function(
        ...
        ddb_client,
        iam_client,
        remove_eks_cluster_event,
        list_eks_cluster_names_event,
        list_imported_eks_clusters_event,
        import_eks_cluster_event,
    ):
