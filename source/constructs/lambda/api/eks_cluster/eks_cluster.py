...
class IamManager():
    ...
    def __init__(self, sub_acct_id: str, region: str):
        svcMgr = SvcManager()
        self.iam = svcMgr.get_client(sub_account_id=sub_acct_id,
                                     service_name='iam',
        ...
        if (account_id == sub_acct_id):
            ...
            self.__eks_oidc_provider_arn_prefix = f"arn:{partition}:iam::{sub_acct_id}:oidc-provider/"
...
class EksClusterManager:
    ...
    def list_eks_cluster_names(self, **args):
        ...
        eks = self.svcMgr.get_client(sub_account_id=accountId,
                                     region=region_name,
                                     service_name='eks',
                                     type=Boto3API.CLIENT)
    ...
    def import_eks_cluster(self, **args) -> str:
        ...
        eks = self.svcMgr.get_client(sub_account_id=eks_account_id,
                                     region=region_name,
                                     service_name='eks',
                                     type=Boto3API.CLIENT)
    ...
    def get_eks_cluster_details(self, eksClusterId) -> str:
        ...
        resp['Item'][
            'deploymentKind'] = self.get_log_agent_eks_deployment_kind_by_id(
                eks_cluster_id=eksClusterId)
    ...
    def is_exist(self, eks_cluster_name: str, aos_domain_id: str,
                 eks_account_id: str, region_name: str) -> bool:
        """
    ...
    def get_log_agent_eks_deployment_kind_by_id(self,
                                                eks_cluster_id: str) -> str:
        """
