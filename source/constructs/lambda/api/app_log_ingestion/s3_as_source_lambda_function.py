...
def child_create_app_log_ingestion(**args):
    ingestion_task = IngestionTask('FluentDS3', args['sourceIds'][0], args['confId'],
                                   args['appPipelineId'], '', args['is_multiline'])
...
def child_delete_app_log_ingestion(**args):
    ...
    ingestion_task = IngestionTask("FluentDS3", "", "", "", args["ids"][0], False)
