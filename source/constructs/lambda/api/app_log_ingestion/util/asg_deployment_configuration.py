...
class ASGDeploymentConfigurationMng:
    ...
    def __get_auto_scaling_group_deploy_content(self) -> str:
        ...
        group_table_resp = instance_group_table.get_item(Key={"id": self.__group_id})
        group_table_item = group_table_resp["Item"]
        deploy_account_id = group_table_item.get("accountId") or account_id
    ...
    def is_group_involved_in_ingestion(self, group_id):
