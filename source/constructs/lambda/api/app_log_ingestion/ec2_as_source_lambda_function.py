...
def child_create_app_log_ingestion(**args):
    ...
    with app_log_ingestion_table.batch_writer() as batch:
        for groupId in group_ids:
            ...
            ingestion_task = IngestionTask('FluentBit', groupId, args['confId'],
                                           args['appPipelineId'], id, args['is_multiline'])
...
def child_delete_app_log_ingestion(**args):
    ...
    for id in args['ids']:
        ...
        ingestion_task = IngestionTask('FluentBit', '', '', '', id, is_multiline)
