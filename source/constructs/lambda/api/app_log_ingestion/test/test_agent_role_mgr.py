        ...
        yield init_ddb(
            {
                ...
                os.environ["EKS_CLUSTER_SOURCE_TABLE_NAME"]: {
                    ...
                    "status": "ACTIVE",
                    "subnetIds": [
                        "subnet-07004ac7f2e2164dd",
                        "subnet-0fc8749589c18edf9",
                        "subnet-014eadb944d87d020",
                        "subnet-0d1d910c8c4399a9d",
                    ],
                    "tags": [],
                    "updatedDt": "2022-07-14T12:55:04Z",
                    "vpcId": "vpc-0d1d79173ff9e6f53",
                },
                os.environ["S3_LOG_SOURCE_TABLE_NAME"]: [],
                os.environ["INSTANCE_GROUP_TABLE_NAME"]: [],
                os.environ["APP_PIPELINE_TABLE_NAME"]: [
                    {
                        "id": "bb8303df-0c78-4a9b-95d3-fd5b4bfd5f79",
                        "aosParas": {
                            "coldLogTransition": 0,
                        ...
                        "createdDt": "2022-07-14T12:57:34Z",
                        "error": "",
                        "kdsParas": {
                            "enableAutoScaling": False,
                            "kdsArn": "arn:aws:kinesis:us-west-2:111111:stream/LogHub-EKS-Cluster-PodLog-Pipeline-bb830-Stream790BDEE4-fpwLPjH5CsQ1",
                            "maxShardNumber": 0,
                            "osHelperFnArn": "arn:aws:lambda:us-west-2:1111111:function:LogHub-EKS-Cluster-PodLog-Pipel-OpenSearchHelperFn-9teq81BBvyOp",
                        ...
                        "stackId": "arn:aws:cloudformation:us-west-2:1111111:stack/LogHub-EKS-Cluster-PodLog-Pipeline-bb830/88d714c0-0374-11ed-8741-06913de18dd5",
                        "status": "ACTIVE",
                        "tags": [{"key": "nb", "value": "test"}],
                    },
                    {
                        "id": "cc8303df-9c78-2a9b-95d3-t35b4bfd5f84",
                        "aosParas": {
                            "coldLogTransition": 0,
                            "domainName": "loghub-aos",
                            "engine": "OpenSearch",
...
def generate_role(sts_client, iam_client, ddb_client):
    from ..util import sys_enum_type
