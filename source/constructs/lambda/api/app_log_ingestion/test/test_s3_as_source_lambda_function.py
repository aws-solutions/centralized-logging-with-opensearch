...
import boto3
import pytest
from moto import mock_s3, mock_lambda, mock_iam, mock_dynamodb, mock_stepfunctions, mock_sts
    ...
    s3_as_source_lambda_function.lambda_handler(
        {
            ...
            "source_ingestion_map": {
                "9681daea-1095-44b5-8e11-40fa935f3aea":
                "818b97bd-7fdd-4b73-b411-acef7a72da96"
            },
