...
def test_create_eks_cluster_pod_log_ingestion(
        ...
        "args": {
            ...
            "parameters": [
                ...
                },
                {
                    ...
                    "ParameterValue": "vpc-wch-private-hbgb2ktamqnb5cedzrty3blelu.us-west-2.es.amazonaws.com"
                },
                {
                ...
                },
                {
                    ...
                    "ParameterValue": "subnet-01f09e14e5b70c11f,subnet-06843d01e3da35b7d"
                },
                {
                ...
                },
                {
                    ...
                    "ParameterValue": "loghub-loghubloggingbucket0fa53b76-1jyvyptgjbge9"
                }
            ],
            "confId": "e8e52b70-e7bc-4bdb-ad60-5f1addf17387",
            "sourceIds": [
            ...
            "source_ingestion_map": {
                "8df489745b1c4cb5b0ef81c6144f9283": "60d7b565-25f4-4c3c-b09e-275e1d02183d"
            }
        },
        "result": {
            "stackId": "arn:aws:cloudformation:us-west-2:1234567890AB:stack/LogHub-EKS-Cluster-PodLog-Pipeline-f34b2/1e8e2860-cc47-11ec-8d95-06039fb616cf",
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "OutputValue": "arn:aws:kinesis:us-west-2:1234567890AB:stream/LogHub-EKS-Cluster-PodLog-Pipeline-f34b2-Stream790BDEE4-aGeLDuMS7B1i"
                },
                {
                    "OutputKey": "MyApiEndpoint869ABE96",
                    "OutputValue": "https://jcrdnmy5s2.execute-api.us-west-2.amazonaws.com/prod/"
                },
                {
                    "OutputKey": "KinesisStreamName",
                    "OutputValue": "LogHub-EKS-Cluster-PodLog-Pipeline-f34b2-Stream790BDEE4-aGeLDuMS7B1i"
                },
                {
    ...
    item = ddb_client.Table(os.environ["APPLOGINGESTION_TABLE"]).get_item(Key={
        'id': '60d7b565-25f4-4c3c-b09e-275e1d02183d'
    })['Item']
