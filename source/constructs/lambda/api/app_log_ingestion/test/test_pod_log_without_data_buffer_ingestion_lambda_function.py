...
from moto import mock_dynamodb, mock_stepfunctions, mock_sts, mock_iam
...
def test_create_eks_cluster_pod_log_ingestion(ddb_client, sfn_client,
                                              iam_roles, sts_client):
    from pod_log_without_data_buffer_ingestion_lambda_function import lambda_handler
