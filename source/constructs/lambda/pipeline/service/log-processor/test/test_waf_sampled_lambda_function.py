            ...
            Rules=[
                {
                    ...
                    "Statement": {
                        "ByteMatchStatement": {
                            ...
                            "TextTransformations": [
                                {"Priority": 200, "Type": "NONE"},
                            ],
                            "PositionalConstraint": "EXACTLY",
                        },
                        "LabelMatchStatement": {"Scope": "LABEL", "Key": "string"},
                        "RegexMatchStatement": {
                            "RegexString": "string",
                            "FieldToMatch": {
                                "SingleHeader": {"Name": "string"},
                    ...
                    "CaptchaConfig": {"ImmunityTimeProperty": {"ImmunityTime": 60}},
                },
            ],
            VisibilityConfig={
                "SampledRequestsEnabled": True,
...
def test_process_log_cf(
    mocker, sts_client, wafv2_cf_client, resp, expected_total, expected_failed, region
):
...
def test_process_log_regional(
    mocker,
    sts_client,
    wafv2_regional_client,
    resp,
    expected_total,
    expected_failed,
    region,
