...
export class InitDynamoDBDataStack extends Construct {
  constructor(scope: Construct, id: string, props: InitDynamoDBDataProps) {
    ...
    const metadataWriterProvider = new cr.Provider(
      this,
      'MetadataWriterProvider',
      {
        onEventHandler:
          microBatchLambdaStack.MetadataWriterStack.MetadataWriter,
    ...
    metadata.push({
      ...
      name: microBatchIAMStack.SendTemplateEmailSNSPublicPolicy
        .managedPolicyName,
    });
    metadata.push({
    ...
    metadata.push({
      ...
      service: 'IAM',
      type: 'Role',
      arn: microBatchSFNStack.LogProcessorStack.LogProcessorStartExecutionRole
        .roleArn,
      name: microBatchSFNStack.LogProcessorStack.LogProcessorStartExecutionRole
        .roleName,
    ...
    metadata.push({
      ...
      service: 'IAM',
      type: 'Role',
      arn: microBatchSFNStack.LogMergerStack.LogMergerStartExecutionRole
        .roleArn,
      name: microBatchSFNStack.LogMergerStack.LogMergerStartExecutionRole
        .roleName,
    ...
    metadata.push({
      ...
      service: 'IAM',
      type: 'Role',
      arn: microBatchSFNStack.LogArchiveStack.LogArchiveStartExecutionRole
        .roleArn,
      name: microBatchSFNStack.LogArchiveStack.LogArchiveStartExecutionRole
        .roleName,
    ...
    metadata.push({
      ...
      service: 'Lambda',
      type: 'Function',
      arn: microBatchLambdaStack.PipelineResourcesBuilderStack
        .PipelineResourcesBuilder.functionArn,
      name: microBatchLambdaStack.PipelineResourcesBuilderStack
        .PipelineResourcesBuilder.functionName,
      url: `https://${Aws.REGION}.console.aws.amazon.com/lambda/home?region=${Aws.REGION}#/roles/functions/${microBatchLambdaStack.PipelineResourcesBuilderStack.PipelineResourcesBuilder.functionName}`,
    });
    metadata.push({
      ...
      type: 'Role',
      arn: microBatchLambdaStack.PipelineResourcesBuilderStack
        .PipelineResourcesBuilderRole.roleArn,
      name: microBatchLambdaStack.PipelineResourcesBuilderStack
        .PipelineResourcesBuilderRole.roleName,
    ...
    metadata.push({
      ...
      type: 'Policy',
      arn: microBatchLambdaStack.PipelineResourcesBuilderStack
        .PipelineResourcesBuilderSchedulePolicy.managedPolicyArn,
      name: microBatchLambdaStack.PipelineResourcesBuilderStack
        .PipelineResourcesBuilderSchedulePolicy.managedPolicyName,
    });
    metadata.push({
      metaName: 'S3ObjectScanningRole',
      service: 'IAM',
      type: 'Role',
      arn: microBatchLambdaStack.S3ObjectScanningStack.S3ObjectScanningRole
        .roleArn,
      name: microBatchLambdaStack.S3ObjectScanningStack.S3ObjectScanningRole
        .roleName,
    ...
    metadata.push({
      ...
      service: 'IAM',
      type: 'Role',
      arn: microBatchLambdaStack.S3ObjectMigrationStack.S3ObjectMigrationRole
        .roleArn,
      name: microBatchLambdaStack.S3ObjectMigrationStack.S3ObjectMigrationRole
        .roleName,
    ...
    metadata.push({
      ...
      service: 'GLUE',
      arn: `arn:${Aws.PARTITION}:glue:${Aws.REGION}:${Aws.ACCOUNT_ID}:database/${microBatchGlueStack.microBatchCentralizedDatabaseName}`,
      name: microBatchGlueStack.microBatchCentralizedDatabaseName,
    });
    metadata.push({
      metaName: 'TmpDatabase',
      service: 'GLUE',
      arn: `arn:${Aws.PARTITION}:glue:${Aws.REGION}:${Aws.ACCOUNT_ID}:database/${microBatchGlueStack.microBatchTmpDatabaseName}`,
      name: microBatchGlueStack.microBatchTmpDatabaseName,
    });
    metadata.push({
    ...
    const metadataWriterCustomResource = new CustomResource(
      this,
    ...
    const cfnMetadataWriterCustomResource = metadataWriterCustomResource.node
      .defaultChild as CfnCustomResource;
    cfnMetadataWriterCustomResource.overrideLogicalId(
      'MetadataWriterCustomResource'
    );

    metadataWriterCustomResource.node.addDependency(
      microBatchDDBStack.MetaTable
    );
  }
}
