...
export class InitSQSStack extends Construct {
  ...
  constructor(scope: Construct, id: string, props: InitSQSProps) {
    ...
    const cfnS3ObjectMigrationDLQ = this.S3ObjectMigrationDLQ.node
      .defaultChild as sqs.CfnQueue;
    cfnS3ObjectMigrationDLQ.overrideLogicalId('S3ObjectMigrationDLQ');

    const S3ObjectMigrationDLQPolicy = new sqs.CfnQueuePolicy(
      this,
    ...
    // Override the logical ID
    const cfnS3ObjectMigrationQ = this.S3ObjectMigrationQ.node
      .defaultChild as sqs.CfnQueue;
    cfnS3ObjectMigrationQ.overrideLogicalId('S3ObjectMigrationQ');

    const S3ObjectMigrationQPolicy = new sqs.CfnQueuePolicy(
      this,
    ...
    // Override the logical ID
    const cfnS3ObjectMergeDLQ = this.S3ObjectMergeDLQ.node
      .defaultChild as sqs.CfnQueue;
    cfnS3ObjectMergeDLQ.overrideLogicalId('S3ObjectMergeDLQ');

    const S3ObjectMergeDLQPolicy = new sqs.CfnQueuePolicy(
      this,
    ...
    // Override the logical ID
    const cfnS3ObjectMergeQ = this.S3ObjectMergeQ.node
      .defaultChild as sqs.CfnQueue;
    cfnS3ObjectMergeQ.overrideLogicalId('S3ObjectMergeQ');

    const S3ObjectMergeQPolicy = new sqs.CfnQueuePolicy(
      this,
