...
import { Aws, Fn, aws_iam as iam, CfnParameter, StackProps, Duration, aws_events_targets as targets, } from "aws-cdk-lib";
...
} from "../service/s3-to-opensearch-common-stack";
import {
...
export class AppPipelineStack extends SolutionStack {
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    if (props.buffer == "S3") {
      ...
      noBufferOpenSearchInitStack.logProcessorFn.role!.attachInlinePolicy(eventBridgePolicy);
