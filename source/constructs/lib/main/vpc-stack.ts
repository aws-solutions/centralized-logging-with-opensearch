...
import { Peer, Port, SecurityGroup, CfnSecurityGroup, FlowLogDestination, FlowLogTrafficType, SubnetType, CfnSubnet, Vpc, IVpc, GatewayVpcEndpointAwsService } from "@aws-cdk/aws-ec2";
...
export class VpcStack extends Construct {
    ...
    constructor(scope: Construct, id: string, props?: VpcProps) {
        ...
        this.proxySg.addIngressRule(Peer.anyIpv4(), Port.tcp(443), "Allow inbound https traffic")
        this.proxySg.addEgressRule(Peer.anyIpv4(), Port.tcp(443), "Allow outbound https traffic")
        ...
        this.searchSg.addIngressRule(this.processSg, Port.tcp(443), "Allow inbound https traffic from processing SG only")
        this.searchSg.addEgressRule(Peer.anyIpv4(), Port.tcp(443), "Allow outbound https traffic")
